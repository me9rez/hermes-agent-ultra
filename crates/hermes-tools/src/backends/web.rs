...
fn ddgs_region_from_env() -> ddgs::Region {
...
fn parse_ddgs_text_backend(name: &str) -> Option<ddgs::TextBackend> {
...
fn ddgs_backend_priority() -> Vec<ddgs::TextBackend> {
...
async fn ddgs_search_with_fallback(
    query: &str,
    num_results: usize,
) -> Result<Vec<ddgs::TextResult>, ToolError> {
    ...
    for backend in ddgs_backend_priority() {
...
impl WebSearchBackend for DdgsSearchBackend {
    async fn search(
        ...
        let hits = ddgs_search_with_fallback(query, num_results).await?;
...
mod ddgs_tests {
    ...
    #[test]
    fn test_ddgs_backend_priority_defaults_to_fast_backends() {
    ...
    #[test]
    fn test_ddgs_backend_priority_parses_env_list() {
